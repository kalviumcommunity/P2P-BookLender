...
('KE' , 'Kenya' , '+254') ,
('KI' , 'Kiribati' , '+686') ,
('KP' , 'Korea, Democratic Peoples Republic of Korea' , '+850') ,
...
-- populate inventory table fior book id 1
insert into Inventory (book,owner)
values (1,4),(1,3);


-- populate books and corresposning author mappings
...
-- populate inventory with book 2
insert into Inventory (book,owner,status)
values (2,2,'nolend'),(2,3,'available');